...
states50<-NASS_states[-c(1,39,46)]
states50_acres<-cbind(states50,state_acres)

soy_state_acres<-soy_short_desc_planted[YEAR>=1990,.(avg_soy_planted=mean(double_val)),by=.(STATE_NAME,STATE_FIPS_CODE)][order(-avg_soy_planted)]
